...
namespace client
{
    ...
    {
        //initial states of connection, subscription and creation of sockets done here.
        ...
        private void button_connect_Click_1(object sender, EventArgs e)
        {
            ...
            else if (button_connect.Text != "Connect")
            {
                ...
                else //the username text written on if subscription and sps subscription button before licking disconnet added to the list if the username is not in the list.
        ...
        private void richTextBox_sps_TextChanged(object sender, EventArgs e)
        {
