...
namespace client
{
    public partial class Form1 : Form
    {
        ...
        //function that handles the general operations when subscripe to if chanell button clicked, the tread for this operaiton gets created and it calls the SubIF function.
        ...
        //function that handles the general operations when subscripe to sps chanell button clicked, the tread for this operaiton gets created and it calls the SubSPS function.
        ...
        //this is the function that manages the events happens after clicking the connect/disconnect button. By this function the connection statuses and the subscription statuses during disconnection tracked for reconnection of the same client.
        ...
        //this functions manages the recieve buffer for the messages coming from server inorder to display them on the channels. Also by each incoming message the functions clears the chanell boxex inorder to prevent duplication of the same message chain.
